...
describe('resource completions', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.async.chat.completions.create({ request: { messages: [{ content: 'string', role: 'system' }], model: 'model' } });
  ...
  test.skip('create: required and optional params', async () => {
    ...
    type: 'type',
    web_search: { search_keywords: ['string'], search_results: [{
    title: 'title',
    url: 'url',
    date: 'date',
    last_updated: 'last_updated',
  ...
  test.skip('get: request options and params are passed correctly', async () => {
    ...
    await expect(client.async.chat.completions.get('api_request', {
    local_mode: true,
