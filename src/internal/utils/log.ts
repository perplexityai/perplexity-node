...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: Perplexity): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: Perplexity): Logger {
